      ...
      <div className="submissions-form">
        ...
        <div className="message-container">
          ...
          <div className="short-message">
            Congratulations, your form has been successfully submitted to the VA for processing. You
            can use the confirmation code below to check the status of your submission at any time
            in the future.
          </div>
        </div>
