...
import SubmissionSuccessForm from './containers/uploadBenefitsForm/SubmissionSuccessForm';
...
export function SiteRoutes() {
  return (
    <Switch>
      ...
      {/* Current routes: */}
      <Route path="/upload-benefits-form-success" component={SubmissionSuccessForm} />
      ...
      />
      <Route
        path="/upload-benefits-form"
        render={() => (
          <Flag
            name="signups_enabled"
            component={UploadBenefitsForm}
            fallbackComponent={DisabledApplyForm}
          />
        )}
      />
      <Route
        path="/review-benefits-form"
        render={() => (
          <Flag
            name="signups_enabled"
